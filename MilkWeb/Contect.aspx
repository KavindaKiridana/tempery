...
AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="MilkWeb.Contact"
%>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  <main aria-labelledby="title">
    <div style="padding: 10px">
      <%-- Top Section: Center, Entity, Date, Mor/Eve, Collector, Collectors
      Farmer Code --%>
      <asp:Panel
        ID="PanelTopSection"
        runat="server"
          ...
          <tr>
            ...
            <td style="padding: 2px">
              <asp:RadioButtonList
                ...
                AutoPostBack="true"
                OnSelectedIndexChanged="rblEntity_SelectedIndexChanged"
              >
                <asp:ListItem
                  Text="Societies"
                  Value="Societies"
          ...
          <tr>
            ...
            <td style="padding: 2px">
              <asp:DropDownList
                ...
                runat="server"
                AutoPostBack="true"
                OnSelectedIndexChanged="ddlCollector_SelectedIndexChanged"
              >
              </asp:DropDownList>
            </td>
      ...
      <asp:Panel
        ...
        Width="100%"
        Height="200px"
        Style="background-color: #f0f0f0; margin-bottom: 10px;"
      >
        <asp:Label
          ID="lblGridPlaceholder"
          runat="server"
          Text="[Data GridView Placeholder]"
          Style="display: block; text-align: center; margin-top: 80px; color: #888;"
        ></asp:Label>
      </asp:Panel>
