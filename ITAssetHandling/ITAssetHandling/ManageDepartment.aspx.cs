...
namespace ITAssetHandling
{
    public partial class ManageDepartment : System.Web.UI.Page
    {
        ...
        {
            if (string.IsNullOrEmpty(txtDName.Text.Trim()))
            {
                lblAlert.Text = "Please enter the department name.";
            ...
            try
            {
                ...
                {
                    command.Parameters.AddWithValue("@DName", txtDName.Text.Trim());
                    command.ExecuteNonQuery();
                    lblAlert.Text = "Department added successfully.";
